...
$(document).ready(function () {
    ...
    document.getElementById("address_field").addEventListener("keydown", function (event) {
        ...
        if (event.keyCode === 13) {
            ...
            document.getElementById("restaurants_tab").click();
        }
    });
...
function updateCart() {
    ...
    for (var i = 0; i < cart.length; i++) {
        ...
        <div class="col-2">\
            <button class="btn btn-danger remove-cart-style" onClick="removeItemFromCart('+ i + ')"><strong>Remove From Cart</strong></button>\
        </div>\
      </div>')
    }
